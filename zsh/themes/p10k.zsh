# Generated by Powerlevel10k configuration wizard on 2020-08-06 at 20:55 PDT.
...
# time, angled separators, round heads, round tails, 2 lines, dotted, full frame,
...
#    taskwarrior             # taskwarrior task count (https://taskwarrior.org/)
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=033
  ...
  typeset -g POWERLEVEL9K_ASDF_PHP_FOREGROUND=99fon
  ...
  #####################################[ wifi: wifi speed ]#####################################
  # WiFi color.
  typeset -g POWERLEVEL9K_WIFI_FOREGROUND=033
  # Custom icon.
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=033
  ...
  function prompt_my_cpu_temp () {
    ...
    integer int_cpu_temp=`echo ${cpu_temp} | awk -F '\.' {'print $1'}`
  	if ((int_cpu_temp >= 100 )); then
  		...
  		p10k segment -s WARM -f yellow -t "${cpu_temp}"
  	fi
  }

  function prompt_my_psn_icon() {
    p10k segment -f 033 -i $'\uE230'
  }
  ...
  function instant_prompt_my_psn_icon() {
    prompt_my_psn_icon
  }
